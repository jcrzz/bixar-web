    ...
    <main className="min-h-screen overflow-hidden bg-[#202020] text-white">
      <nav className={`fixed inset-x-0 top-0 z-40 border-b border-white/10 bg-[#202020]/90 backdrop-blur-xl transition-transform duration-300 ${navVisible ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10">
          ...
          <div className="hidden items-center gap-9 md:flex"><a href="#inicio" className="nav-link">Inicio</a><a href="#ingenieria" className="nav-link">Ingeniería</a><a href="#proyectos" className="nav-link">Proyectos</a><a href="#nosotros" className="nav-link">Nosotros</a><a href="#contacto" className="nav-link">Contacto</a></div>
